...
public class SensorManager implements Runnable{
	...
	private final NUM_LASER_SENSORS = 1;
	private final NUM_ANALOG_SENSORS = 2;
	private final NUM_GPIO_SENSORS = 8;
	...
	public double[] ranges;		//most recent ranging data 0 = laser, 1-2 = analog sonar, 3-10 = gpio sonar
